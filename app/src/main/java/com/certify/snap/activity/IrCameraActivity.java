...
public class IrCameraActivity extends BaseActivity implements ViewTreeObserver.OnGlobalLayoutListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (barcodeFormatArrayList.size() > 0) barcodeFormatArrayList.clear();
    ...
    private void codeScannerInit() {
        ...
        mCodeScanner.setDecodeCallback(new DecodeCallback() {
            ...
            public void onDecoded(@NonNull Result result) {
                ...
                Logger.debug(TAG, "onDecoded" + result.getText());
                if (!qrCodeReceived) {
                    qrCodeReceived = true;
        ...
        mCodeScanner.setErrorCallback(new ErrorCallback() {
            ...
            public void onError(@NonNull Exception error) {
                Logger.error("mCodeScanner : onError", error.getMessage());
            }
        });
    }
...
//                .additionalRotation(270) //
    ...
    @Override
    public void onQRCodeScanSuccess() {
        clearQrCodePreview();
