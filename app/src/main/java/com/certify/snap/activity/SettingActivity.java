...
public class SettingActivity extends Activity implements JSONObjectCallback,SettingCallback {
    ...
    TextView access_pwd, upload_logo, setTemp, parameter_setting, activate_tv, endpoint, tv_version, tv_thermal_setting, tv_scan_setting, tv_confirmation_setting, tv_serial_no, tv_guide_setting, tv_facaial_settings, tv_member_management;
    Typeface rubiklight;
