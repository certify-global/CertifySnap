package com.certify.snap.arcface.util.camera;
...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    public void start() {
        synchronized (this) {
            ...
            Log.e("getNumberOfCameras--", mCameraId + "-" + specificCameraId);
            ...
            try {
                ...
                Log.e("yw1", "onCameraOpened11111111" + displayOrientation);
    ...
    public void stop() {
        synchronized (this) {
            if (mCamera == null) {
                Log.e("onDestroy---", "mCamera null");
                return;
            }
            Log.e("onDestroy---", "mCamera stop");
