 ...
 * 人脸操作辅助类
 */
public class FaceHelperPro {
    private static final String TAG = "FaceHelperPro";
    /**
     * 线程池正在处理任务
     */
    ...
    private FaceHelperPro(Builder builder) {
...
//                        Log.i(TAG, "run: fr costTime = " + (System.currentTimeMillis() - frStartTime) + "ms");
    ...
    public static final class Builder {
        ...
        public FaceHelperPro build() {
            return new FaceHelperPro(this);
        }
    }
}
