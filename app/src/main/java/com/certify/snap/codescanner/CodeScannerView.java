 ...
 *
 * @see com.certify.snap.codescanner.CodeScanner
 */
public final class CodeScannerView extends ViewGroup {
    ...
    private com.certify.snap.codescanner.ViewFinderView mViewFinderView;
    private ImageView mAutoFocusButton;
    private ImageView mFlashButton;
    private com.certify.snap.codescanner.Point mPreviewSize;
    private SizeListener mSizeListener;
    private com.certify.snap.codescanner.CodeScanner mCodeScanner;
    ...
    private void initialize(@NonNull final Context context, @Nullable final AttributeSet attrs,
        ...
        mViewFinderView = new com.certify.snap.codescanner.ViewFinderView(context);
    ...
    public boolean onTouchEvent(@NonNull final MotionEvent event) {
        final com.certify.snap.codescanner.CodeScanner codeScanner = mCodeScanner;
        final com.certify.snap.codescanner.Rect frameRect = getFrameRect();
        ...
        if (codeScanner != null && frameRect != null &&
            ...
            codeScanner.performTouchFocus(
                    new com.certify.snap.codescanner.Rect(x - areaSize, y - areaSize, x + areaSize, y + areaSize)
                            .fitIn(frameRect));
        }
    ...
    @NonNull
    com.certify.snap.codescanner.ViewFinderView getViewFinderView() {
        return mViewFinderView;
    }

    @Nullable
    com.certify.snap.codescanner.Rect getFrameRect() {
        return mViewFinderView.getFrameRect();
    }

    void setPreviewSize(@Nullable final com.certify.snap.codescanner.Point previewSize) {
    ...
    void setCodeScanner(@NonNull final com.certify.snap.codescanner.CodeScanner codeScanner) {
    ...
    private void performLayout(final int width, final int height) {
        final com.certify.snap.codescanner.Point previewSize = mPreviewSize;
        if (previewSize == null) {
    ...
    private final class AutoFocusClickListener implements OnClickListener {
        ...
        public void onClick(final View view) {
            final com.certify.snap.codescanner.CodeScanner scanner = mCodeScanner;
