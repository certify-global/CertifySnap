...
final class Utils {
    ...
    @NonNull
    public static com.certify.snap.codescanner.Point findSuitableImageSize(@NonNull final Parameters parameters,
            ...
            for (float distortion = MIN_DISTORTION; distortion <= MAX_DISTORTION;
                ...
                for (final Size size : sizes) {
                    ...
                    if (width * height >= MIN_PREVIEW_PIXELS &&
                        ...
                        return new com.certify.snap.codescanner.Point(width, height);
                    }
                }
            }
        }
        ...
        return new com.certify.snap.codescanner.Point(defaultSize.width, defaultSize.height);
    }
    ...
    public static void configureFocusArea(@NonNull final Parameters parameters,
                                          @NonNull final com.certify.snap.codescanner.Rect area, final int width, final int height, final int orientation) {
        final List<Area> areas = new ArrayList<>(1);
        final com.certify.snap.codescanner.Rect rotatedArea =
    ...
    public static void configureDefaultFocusArea(@NonNull final Parameters parameters,
                                                 @NonNull final com.certify.snap.codescanner.Rect frameRect, @NonNull final com.certify.snap.codescanner.Point previewSize,
                                                 @NonNull final com.certify.snap.codescanner.Point viewSize, final int width, final int height,
    ...
    public static void configureDefaultFocusArea(@NonNull final Parameters parameters,
                                                 @NonNull final DecoderWrapper decoderWrapper, @NonNull final com.certify.snap.codescanner.Rect frameRect) {
    ...
    public static int getDisplayOrientation(@NonNull final Context context,
        ...
        if (!Util.isDeviceF10()) rotation = 2;
        switch (rotation) {
    ...
    @NonNull
    public static com.certify.snap.codescanner.Point getPreviewSize(final int imageWidth, final int imageHeight,
                                                                    final int frameWidth, final int frameHeight) {
        if (imageWidth == frameWidth && imageHeight == frameHeight) {
            return new com.certify.snap.codescanner.Point(frameWidth, frameHeight);
        }
        final int resultWidth = imageWidth * frameHeight / imageHeight;
        if (resultWidth < frameWidth) {
            return new com.certify.snap.codescanner.Point(frameWidth, imageHeight * frameWidth / imageWidth);
        } else {
            return new com.certify.snap.codescanner.Point(resultWidth, frameHeight);
        }
    }

    @NonNull
    public static com.certify.snap.codescanner.Rect getImageFrameRect(final int imageWidth, final int imageHeight,
                                                                      @NonNull final com.certify.snap.codescanner.Rect viewFrameRect, @NonNull final com.certify.snap.codescanner.Point previewSize,
                                                                      @NonNull final com.certify.snap.codescanner.Point viewSize) {
        ...
        return new com.certify.snap.codescanner.Rect(Math.max(Math.round((viewFrameRect.getLeft() + wD) * wR), 0),
